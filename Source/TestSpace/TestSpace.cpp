...
void TestSpace_Initialize() 
{
	...
	float nL = 7;
	for (float x = 8; x < 15; x++)
	{
		for (float z = 0; z < 9; z++)
		{
			for (float y = 0; y < nL; y++)
			{
				g_pBlockL->CreateBlockRel(D3DXVECTOR3(x, y, z));
			}
		}
