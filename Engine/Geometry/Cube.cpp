...
static CubeVertex3D Cube[] =
{
	...
	//裏面
	{ { 0.5f,	 0.5f, 0.5f },{ 0.0f,0.0f,1.0f }, g_CubeColor,{ 0,0} },
	{ { -0.5f,	 0.5f, 0.5f },{ 0.0f,0.0f,1.0f }, g_CubeColor,{ 1,0 } },
	{ { 0.5f,	-0.5f, 0.5f },{ 0.0f,0.0f,1.0f }, g_CubeColor,{ 0,1 } },

	{ { -0.5f,	 0.5f, 0.5f },{ 0.0f,0.0f,1.0f }, g_CubeColor,{ 1,0 } },
	{ { -0.5f,	-0.5f, 0.5f },{ 0.0f,0.0f,1.0f }, g_CubeColor,{ 1,1 } },
	{ { 0.5f,	-0.5f, 0.5f },{ 0.0f,0.0f,1.0f }, g_CubeColor,{ 0,1 } },
...
void Cube_Initialize()
{
	...
	for(int i = 0; i < CUBE_PRIMITIVE_NUM/2; i++)
	{
		int j = i * 6;		//インデックス数
		int n = i * 4;		//頂点数
